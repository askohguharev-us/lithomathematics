...
% ============================================================
% Additional Introductory Sections (Diamond 20/10 Enhancement)
% Cross-linked to Chapter 0 (Foundational Definitions and Conventions)
% ============================================================
...
\section{Glossary (Quick Orientation)}\label{sec:glossary}
\begin{description}
...
% We index hypotheses H1–H4 for internal cross-referencing.
\begin{description}
...
\section{Methodological Innovations}\label{sec:methods-innovation}
\begin{enumerate}
...
\paragraph{Partial transmission (Robin/impedance).}
...
% ------------------------------------------------------------
% End of Additional Introductory Sections (Diamond 20/10)
% ------------------------------------------------------------
